...
Read-only by construction &mdash; the tile is fed through a same-origin proxy and the widget token never reaches the browser. Requires BombVault &gt;= 6.9.0 and a widget token (BombVault &rarr; Settings &rarr; System &rarr; Dashboard widget).
